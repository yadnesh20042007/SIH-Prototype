    ...
    <main className="min-h-screen bg-[#F7F9FB]">
      ...
      <div className="mx-auto max-w-[1500px] px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6 border-l-[3px] border-[#0A66C2] pl-4">
          ...
          <h1 className="m-0 mt-1 text-[1.45rem] font-bold text-[#1D2226]">Pending final approval</h1>
          <p className="m-0 mt-1 text-[0.78rem] text-[#667085]">Confirm the technical review history and persisted R76 evidence before the final decision.</p>
        </div>
        <ApprovalQueueScreen mode="approval" />
      </div>
    </main>
  );
}
